...
<style>
    ...
    * {
    ...
    .content {
        background: url('https://osssource.alizila.com/uploads/2021/07/100-meters-sprint-olympics-rio-2016-shutterstock-992x558-1.jpg')no-repeat;
...
<div class="content" style="height: 670px;">
    <div class="welcomeText">
        <div class="welcome">
            <h1 class="greet" style="color: #000000;">FunOLYMPIC RESULTS</h1>
        </div>
...
<br>
<br>
<h1 class='text-center'>Pick an FunOlympic Game</h1>
<br>
