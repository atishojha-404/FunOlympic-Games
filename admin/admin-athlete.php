                ...
                <form class="needs-validation" novalidate>
                    <fieldset data-index=1 class="ms-step-1 active seen">
                        <div class="form-row">
                            ...
                            <div class="form-group floating-label-container col-md-6">
                                <label for="inputPassword1" class="floating-label">DOB</label><br>
                                <input type="date" class="form-control" id="inputPassword1" required>
                            </div>
                        </div>
                        <div class="form-group floating-label-container">
                            <label for="firstname" class="floating-label">First Name</label><br>
                            <input type="text" class="form-control" id="firstname" placeholder="Write here..." required>
                        </div>
                        <div class="form-group floating-label-container">
                            <label for="surname" class="floating-label">Surname</label><br>
                            <input type="text" class="form-control" id="surname" placeholder="Write here..." required>
                        </div>


                        <div class="form-group floating-label-container">
                            <label for="surname" class="floating-label">Select Country</label><br><br>
                            <div id="dropdown" required></div>
                        </div>

                        <div class="form-group floating-label-container">
                            <label for="surname" class="floating-label">First Olympic Games</label><br>
                            <input type="text" class="form-control" id="surname" placeholder="Write here..." required>
                        </div>

                        <div class="form-group floating-label-container">
                            <label for="surname" class="floating-label">Games Participations</label><br>
                            <input type="text" class="form-control" id="surname" placeholder="Write here..." required>
                        </div>

                        <div class="form-group floating-label-container">
                            <label for="surname" class="floating-label">Olympic Medals</label><br>
                            <input type="text" class="form-control" id="surname" placeholder="Write here..." required>
                        </div>

                        <div class="form-group floating-label-container">
                            <label for="surname" class="floating-label">Social Media Links</label><br>
                            <input type="text" class="form-control" id="surname" placeholder="Write here..." required>
                        </div>

                        <div class="form-group floating-label-container">
                            <label for="surname" class="floating-label">Biography</label><br>
