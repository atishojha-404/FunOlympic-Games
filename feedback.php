                    ...
                    <div class="card-body">
                        <form action="#" method="post" class="px-4" id="feedback-form">
                            ...
                            <div class="form-group">
                                <input type="text" name="subject" placeholder="Write Your Subject" class="form-control-lg form-control rounded-0" required style="color: #ffffff;">
                            </div>

                            <div class="form-group">
                                <textarea name="feedback" id="" class="form-control-lg form-control rounded-0" placeholder="Write Your Feedback Here..." rows="8" required style="color: #ffffff;"></textarea>
                            </div>

                            <div class="form-group">
                                <input type="submit" name="feedbackBtn" id="feedbackBtn" value="Send Feedback" class="btn btn-primary btn-block btn-lgg rounded-0">
                            </div>
                        </form>
                    </div>
                </div>
