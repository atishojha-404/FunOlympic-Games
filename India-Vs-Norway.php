...
<style>
    ...
    * {
    ...
    .content {
        background: url('https://img.olympicchannel.com/images/image/private/t_16-9_1240-700/f_auto/v1538355600/primary/ghciazhg3kpcyvko15ez')no-repeat;
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 style="color: #ffffff; font-size: 4rem; font-weight: 700;  line-height: 4rem; margin: 2.4rem 0px; text-transform: uppercase; width: auto;">
                India vs Norway, Davis Cup World Group I live streaming: Focus on Ramkumar Ramanathan, Casper Ruud - full schedule
            </h1>
        </div>
        <div class="col-lg-12">
            <h2 style="color: #ffffff; font-size: 1.3rem; line-height: 2.3rem; margin-top: 2.4rem;">
                The Indian tennis team will play Norway in a Davis Cup 2022 World Group I tie on September 16 and 17 at Hakons Hall in Lillehammer, Norway. India have named their top four men’s singles players for the away tie.
                <br>
                World No. 276 Ramkumar Ramanathan will lead the charge in the singles, along with Prajnesh Gunneswaran (335), Sasikumar Mukund (416) and Sumit Nagal (483).
                <br>
                Meanwhile, Yuki Bhambri and Saketh Myneni, who won the Challenger title in Mallorca earlier this month, will team up for the doubles. The Bhambri-Myneni duo has enjoyed plenty of success in 2022, winning five Challengers and two Futures events. Watch live streaming of India vs Norway Davis Cup match.
            </h2>
        </div>
    </div>
...
<section class="section-news">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="single-news">
                    <a href="#"><img style="max-height: 170px;" src="https://img.olympicchannel.com/images/image/private/t_16-9_400-225/f_auto/primary/xbjf99ixaqbealg6xgb5" alt=""></a>
                    <div class="content" style="background-color: #000000!important; background:url(); padding:0px;">
            ...
            <div class="col-12 col-md-4">
                <div class="single-news">
                    <a href="#"><img style="max-height: 170px;" src="https://img.olympicchannel.com/images/image/private/t_16-9_400-225/f_auto/primary/xom2vr8u5c3a9omdqvlz" alt=""></a>
                    <div class="content" style="background-color: #000000!important; background:url(); padding:0px;">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="single-news">
                    <a href="#"><img style="max-height: 170px;" src="https://img.olympicchannel.com/images/image/private/t_16-9_400-225/f_auto/primary/fifgf1h1gwnfb0mjoq0k" alt=""></a>
                    <div class="content" style="background-color: #000000!important; background:url(); padding:0px;">
            ...
            <div class="col-12 col-md-4">
                <div class="single-news">
                    <a href="#"><img style="max-height: 170px;" src="https://tpc.googlesyndication.com/simgad/3482695119929836243?" alt=""></a>
                    <div class="content" style="background-color: #000000!important; background:url(); padding:0px;">
            ...
            <div class="col-12 col-md-4">
                <div class="single-news">
                    <a href="#"><img style="max-height: 170px;" src="https://img.olympicchannel.com/images/image/private/t_16-9_400-225/f_auto/primary/xah7mi1cepd1nkggfcky" alt=""></a>
                    <div class="content" style="background-color: #000000!important; background:url(); padding:0px;">
